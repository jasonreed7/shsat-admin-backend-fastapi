...
def create_category(db: SessionLocal, category: tag_schemas.CategoryCreate) -> tag_models.Category:
    category_model = tag_models.Category(
        name=category.name
    )
...
def create_subcategory(db: SessionLocal, subcategory: tag_schemas.SubcategoryCreate) -> tag_models.Subcategory:
...
def create_resource(db: SessionLocal, resource: tag_schemas.ResourceCreate) -> tag_models.Resource:
